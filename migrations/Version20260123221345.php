 ...
 */
final class Version20260123221345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contact_messages (id BINARY(16) NOT NULL, email VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, status VARCHAR(255) NOT NULL, assigned_to BINARY(16) DEFAULT NULL, answer LONGTEXT DEFAULT NULL, answered_by BINARY(16) DEFAULT NULL, answered_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');

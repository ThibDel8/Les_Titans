...
use App\SharedKernel\Security\Infrastructure\Symfony\Form\ChangePasswordFormType;
use App\SharedKernel\Security\Infrastructure\Symfony\Form\ResetPasswordRequestFormType;
...
class ResetPasswordController extends AbstractController
{
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('reset-password@les-titans.fr', 'Reset Password'))
